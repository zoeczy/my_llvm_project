...
for.body3:                                        ; preds = %for.cond1
  ...
  %4 = load i32, ptr @invariant, align 4
  %5 = load i32, ptr %j, align 4
  %add4 = add nsw i32 %4, %5
  store i32 %add4, ptr %look, align 4
  br label %for.inc
...
for.end7:                                         ; preds = %for.cond
  ...
  %call8 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) %call, i32 noundef %8)
