; ModuleID = 'for_sum.cpp'
source_filename = "for_sum.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_for_sum.cpp, ptr null }]
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_for_sum.cpp() #0 section ".text.startup" {
entry:
